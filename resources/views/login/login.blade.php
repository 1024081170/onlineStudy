...
<div class="login" style="background:url({{asset('images/12.jpg')}}) right center no-repeat #fff">
    <h2>登录</h2>
    <form style="width:600px">
        ...
        <div class="loginbtn lb">
            <a href="/login/register" class="link-muted">还没有账号？立即免费注册</a>
            <span>&nbsp;&nbsp;|&nbsp;&nbsp;</span>
    ...
    <div class="hezuologo">
        ...
        <div class="hezuoimg">
            <img src="{{asset('images/hezuoqq.png')}}" class="hzqq" title="QQ" width="40" height="40"/>
            <img src="{{asset('images/hezuowb.png')}}" class="hzwb" title="微博" width="40" height="40"/>
        </div>
