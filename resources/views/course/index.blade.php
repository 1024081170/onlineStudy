...
@section('content')
	...
	<span class="select">
      ...
      <a href="#" class="sellink"></a>
            ...
            <ul class="courseul">
                <li class="curr" style="border-radius:3px 3px 0 0;background:#fb5e55;"><h3 style="color:#fff;"><a
                                href="#"
                                class="whitea">全部课程</a>
                    </h3>
                <li>
            ...
            <ul class="courseulr">
                <li>
                    <div class="courselist">
                        <a href="/course/coursecont" target="_blank"><img style="border-radius:3px 3px 0 0;" width="240"
                                                                       src="images/c1.jpg" title="会计基础"></a>
                        <p class="courTit"><a href="/course/coursecont" target="_blank">会计基础</a></p>
                        <div class="gray">
                ...
                <li>
                    <div class="courselist">
                        <a href="/course/coursecont" target="_blank"><img style="border-radius:3px 3px 0 0;" width="240"
                                                                       src="images/c2.jpg" title="会计基础"></a>
                        <p class="courTit"><a href="/course/coursecont" target="_blank">HTTP下载课程</a></p>
                        <div class="gray">
                            <span>5课时 60分钟</span>
                            <span class="sp1">1255555人学习</span>
                            <div style="clear:both"></div>
                ...
                <li>
                    <div class="courselist">
                        <a href="/course/coursecont" target="_blank"><img style="border-radius:3px 3px 0 0;" width="240"
                                                                       src="images/c3.jpg" title="会计基础"></a>
                        <p class="courTit"><a href="/course/coursecont" target="_blank">HTTP下载课程</a></p>
                        <div class="gray">
                            <span>5课时 60分钟</span>
                            <span class="sp1">1255555人学习</span>
