...
<head>
    ...
    <link rel="stylesheet" href="{{asset('video-js.css')}}" >
...
<div class="linevideo" style="overflow-x:hidden">
    <span class="returnindex"><a class="gray" href="/course/coursecont1" style="font-size:14px;">返回课程</a></span>
    <span class="taskspan"><span class="ts">课时100</span>&nbsp;&nbsp;<b class="tasktit">会计的概念与目标1</b></span>
    <div style="width:100%;margin-top:20px;">
        <video width="auto" id="example_video_1" class="video-js vjs-default-skin  vjs-big-play-centered vvi " controls preload="none"  poster="{{asset('images/c8.jpg')}}" data-setup="{}"><!--poster是视频未播放前的展示图片-->
