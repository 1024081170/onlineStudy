    ...
    <div class="coursecont">
        <div class="coursepic1">
            ...
            <div class="course_img1">
                <img src="{{asset('images/c1.jpg')}}" height="140">
            </div>
            <div class="course_xq">
                ...
                <span class="courstime1"><p style="border:none;">课程时长<br/><span
                                class="coursxq_num">3小时20分</span></p></span>
            </div>
            <div class="course_xq2">
                <a class="course_learn" href="/course/video">开始学习</a>
            </div>
                ...
                <div class="tab_box">
                        ...
                        <dl class="mulu noo">
                            <div>
                                ...
                                <div class="mulu_con">
                                    ...
                                    <a href="video.html">
                                        <dd><strong class="cataloglink">课时1：会计的概念与目标1</strong><i class="fini nn"></i>
                                        </dd>
                                    </a>
                                    <a href="video.html">
                                        <dd><strong class="cataloglink">课时2：会计的概念与目标2</strong><i class="fini fn"></i>
                                        </dd>
                                    </a>
                                    <dd class="smalltitle"><strong>第二节&nbsp;&nbsp;会计的职能与方法</strong></dd>
                                    <a href="video.html">
                                        <dd><strong class="cataloglink">课时1：会计的职能与方法1</strong><i class="fini nn"></i>
                                        </dd>
                                    </a>
                                    <a href="video.html">
                                        <dd><strong class="cataloglink">课时2：会计的职能与方法2</strong><i class="fini fn"></i>
                                        </dd>
                                    </a>
                                    <a href="video.html">
                                        <dd><strong class="cataloglink">课时1：会计的职能与方法3</strong><i class="fini ff"></i>
                                        </dd>
                                    </a>
                                </div>
                            </div>
                            <div>
                                ...
                                <div class="mulu_con">
                                    ...
                                    <a href="video.html">
                                        <dd><strong class="cataloglink">课时1：会计要素与会计等式1</strong><i class="fini nn"></i>
                                        </dd>
                                    </a>
                                    <a href="video.html">
                                        <dd><strong class="cataloglink">课时2：会计要素与会计等式2</strong><i class="fini nn"></i>
                                        </dd>
                                    </a>
                                </div>
                            </div>
                    ...
                    <div class="hide">
                        <div>
                            ...
                            <div class="c_eform">
                                <textarea rows="7" class="pingjia_con"
                                          onblur="if (this.value =='') this.value='评价详细内容';this.className='pingjia_con'"
                                          onclick="if (this.value=='评价详细内容') this.value='';this.className='pingjia_con_on'">评价详细内容</textarea>
                    ...
                    <div class="hide">
                        <div>
                            ...
                            <div class="c_eform">
                                <input type="text" class="pingjia_con" value="请输入问题标题"
                                       onblur="if (this.value =='') this.value='请输入问题标题';this.className='pingjia_con'"
                                       onclick="if (this.value=='请输入问题标题') this.value='';this.className='pingjia_con_on'"/><br/>
                                <textarea rows="7" class="pingjia_con"
                                          onblur="if (this.value =='') this.value='请输入问题的详细内容';this.className='pingjia_con'"
                                          onclick="if (this.value=='请输入问题的详细内容') this.value='';this.className='pingjia_con_on'">请输入问题的详细内容</textarea>
                            ...
                            <p class="peptime pswer"><span class="pepask">回答(<strong><a class="bluelink" href="#">10</a></strong>)&nbsp;&nbsp;&nbsp;&nbsp;浏览(<strong><a
                                                class="bluelink" href="#">10</a></strong>)</span>2015-01-02</p>
                            </span>
                                </li>
                                <li>
                        	<span class="pephead"><img src="{{asset('images/0-0.JPG')}}" width="50" title="候候">
                        ...
                        <div>
                            <ul class="notelist">
                                <li>
                                    ...
                                    <p class="gray"><b class="coclass">课时：<a href="#"
                                                                             target="_blank">会计的概念与目标1</a></b><b
                                                class="cotime">上传时间：<b class="coclass">2015-05-8</b></b></p>

                                </li>
                                <li>
                                    <p class="mbm mem_not"><a href="#" class="peptitle">资料.rar</a></p>
                                    <p class="gray"><b class="coclass">课时：<a href="#"
                                                                             target="_blank">会计的概念与目标2</a></b><b
                                                class="cotime">上传时间：<b class="coclass">2015-05-8</b></b></p>
        ...
        <div class="courightext">
                ...
                <div class="cr1">
                    ...
                    <div class="teacher">
                        <div class="teapic ppi">
                            <a href="/index/teacher" target="_blank"><img src="{{asset('images/teacher.png')}}"
                                                                          width="80" class="teapicy" title="张民智"></a>
                            <h3 class="tname"><a href="/index/teacher" class="peptitle" target="_blank">张民智</a>
                                <p style="font-size:14px;color:#666">会计讲师</p></h3>
                        </div>
                        <div class="clearh"></div>
                        <p>十年以上Linux从业经验， 培训经验超过八年。在各 个知名培训机构做过金牌 讲师、学科负责人，培训 学员过万人。曾获红帽认 证讲师，微软认证讲师等 资质认证。教学以逻辑性
                            强、教学细致、知识点准 确著称。</p>
                    </div>
                </div>
            </div>
            ...
            <div class="ctext">
                <div class="cr1">
                    ...
                    <div class="teacher zxxy">
                        <ul class="stuul">
                            <li><img src="{{asset('images/0-0.JPG')}}" width="60" title="张三李四">
                                <p class="stuname">张三李四</p></li>
                            <li><img src="{{asset('images/0-0.JPG')}}" width="60" title="张三李四">
                                <p class="stuname">张三李四</p></li>
                            <li><img src="{{asset('images/0-0.JPG')}}" width="60" title="张三李四">
                                <p class="stuname">张三李四</p></li>
            ...
            <div class="ctext">
                <div class="cr1">
                    ...
                    <div class="teacher">
                        <div class="teapic">
                            <a href="#" target="_blank"><img src="{{asset('images/c1.jpg')}}" height="60"
                                                             title="财经法规与财经职业道德"></a>
                            <h3 class="courh3"><a href="#" class="peptitle" target="_blank">财经法规与财经职业道德</a></h3>
                        </div>
                        <div class="clearh"></div>
                        <div class="teapic">
                            <a href="#" target="_blank"><img src="{{asset('images/c2.jpg')}}" height="60"
                                                             title="财经法规与财经职业道德"></a>
                            <h3 class="courh3"><a href="#" class="peptitle" target="_blank">财经法规与财经职业道德</a></h3>
                        </div>
                        <div class="clearh"></div>
                        <div class="teapic">
                            <a href="#" target="_blank"><img src="{{asset('images/c3.jpg')}}" height="60"
                                                             title="财经法规与财经职业道德"></a>
                            <h3 class="courh3"><a href="#" class="peptitle" target="_blank">财经法规与财经职业道德</a></h3>
                        </div>
                        <div class="clearh"></div>
                    ...
                    <div class="tab_box">
                        <div>
                            <form class="loginform pop">
                                ...
                                <div class="clearh"></div>
                                <div class="popbtn">
                                    <label><input type="checkbox" checked="checked"> <span class="jzmm">记住密码</span>
                                    </label>&nbsp;&nbsp;
