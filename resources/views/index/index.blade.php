...
<div class="content">
        ...
        <div id="revolution-slider" style="max-height:500px !important; background:#46B0AC">
            <ul>
                <li data-transition="fade" data-slotamount="10" data-masterspeed="300" data-thumb="images-slider/thumbs/thumb1.jpg">
                    <!--  BACKGROUND IMAGE -->
                    <img src="{{asset('images-slider/wide2.jpg')}}" alt="" />
                    ...
                    <div class="tp-caption sfl"
                        ...
                        <img src="{{asset('images-slider/rb.png')}}" alt="">
                    </div>
                ...
                <li data-transition="fade" data-slotamount="10" data-masterspeed="300" data-thumb="{{asset('images-slider/thumbs/thumb1.jpg')}}">
                    <!--  BACKGROUND IMAGE -->
                    <img src="{{asset('images-slider/wide3.jpg')}}" alt="" />
                    ...
                    >
                        <img src="{{asset('images-slider/guy-shadow.png')}}" alt="">
                    </div>
                    ...
                    <div class="tp-caption small-white lft"
                         ...
                         data-start="2600"
                         data-easing="easeOutExpo">
                        <img src="{{asset('images-slider/spotlight.png')}}" alt="">
                    </div>
                    ...
                    <div class="tp-caption fade"
                         ...
                         data-start="2600"
                         data-easing="easeOutExpo">
                        <img src="{{asset('images-slider/guy.png')}}" alt="">
                    </div>
                </li>
                ...
                <li data-transition="fade" data-slotamount="10" data-masterspeed="300" data-thumb="{{asset('images-slider/thumbs/thumb1.jpg')}}">
                    <!--  BACKGROUND IMAGE -->
                    <img src="{{asset('images-slider/wide1.jpg')}}" alt="" />
                    ...
                    <div class="caption large_text sfb"
                         ...
                         data-start="800"
                         data-easing="easeOutExpo">
                        <img src="{{asset('images-slider/our-features.png')}}" alt="">
                    </div>
                    ...
                    <div class="tp-caption sfr"
                         ...
                         data-start="1000"
                         data-easing="easeOutBack">
                        <img src="{{asset('images-slider/lu.png')}}" alt="">
                    </div>
                    ...
                    <div class="tp-caption sfr"
                         ...
                         data-start="1200"
                         data-easing="easeOutBack">
                        <img src="{{asset('images-slider/clean.png')}}" alt="">
                    </div>
                    ...
                    <div class="tp-caption sfr"
                         ...
                         data-start="1400"
                         data-easing="easeOutBack">
                        <img src="{{asset('images-slider/lm.png')}}" alt="">
                    </div>
                    ...
                    <div class="tp-caption sfr"
                         ...
                         data-start="1600"
                         data-easing="easeOutBack">
                        <img src="{{asset('images-slider/responsive.png')}}" alt="">
                    </div>
                    ...
                    <div class="tp-caption sfr"
                         ...
                         data-start="1800"
                         data-easing="easeOutBack">
                        <img src="{{asset('images-slider/lb.png')}}" alt="">
                    </div>
                    ...
                    <div class="tp-caption sfr"
                         ...
                         data-start="2000"
                         data-easing="easeOutBack">
                        <img src="{{asset('images-slider/bootstrap.png')}}" alt="">
                    </div>
                    ...
                    <div class="tp-caption sfl"
                         ...
                         data-start="2200"
                         data-easing="easeOutBack">
                        <img src="{{asset('images-slider/ru.png')}}" alt="">
                    </div>
                    ...
                    <div class="tp-caption sfl"
                         ...
                         data-start="2400"
                         data-easing="easeOutBack">
                        <img src="{{asset('images-slider/solid.png')}}" alt="">
                    </div>
                    ...
                    <div class="tp-caption sfl"
                         ...
                         data-start="2600"
                         data-easing="easeOutBack">
                        <img src="{{asset('images-slider/rm.png')}}" alt="">
                    </div>
                    ...
                    <div class="tp-caption sfl"
                         ...
                         data-start="2800"
                         data-easing="easeOutBack">
                        <img src="{{asset('images-slider/lightweight.png')}}" alt="">
                    </div>
                    ...
                    <div class="tp-caption sfl"
                         ...
                         data-start="3200"
                         data-easing="easeOutBack">
                        <img src="{{asset('images-slider/fresh.png')}}" alt="">
                    </div>
                </li>
    ...
    <div class="td1">
        <div class="tdcont">
            <span class="tdimg"><img src="{{asset('images/ico4.jpg')}}" width="450"></span>
        <span class="tdtext">
        	<h3>完全免费课程</h3>
    ...
    <div class="td2">
        <div class="tdcont">
            <span class="tdimg1"><img src="{{asset('images/ico5.jpg')}}" width="500"></span>
        <span class="tdtext1">
    ...
    <div class="td1">
        <div class="tdcont np">
            <span class="tdimg" style="margin-top:80px"><img src="{{asset('images/ico6.jpg')}}" width="550"></span>
    ...
    <div class="td2 np">
        <div class="tdcont np">
            <span class="tdimg1 ni"><img src="{{asset('images/ico7.png')}}" width="300"></span>
                    ...
                    <ul class="courseul" id="myTab3_Content0" style="display: block;">
                        <li>
                            <div class="courselist">
                                <img width="263" style="border-radius:3px 3px 0 0;" src="{{asset('images/c1.jpg')}}" >
                        ...
                        <li>
                            <div class="courselist">
                                <img width="263" style="border-radius:3px 3px 0 0;" src="{{asset('/images/cl.jpg')}}" >
                                <p class="courTit">HTTP下载课程</p>
                                <div class="gray">
                                    <span>1小时前更新</span>
                                    <span class="sp1">1255555人学习</span>
